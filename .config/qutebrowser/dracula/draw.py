def blood(c, options={}):
    ...
    # Foreground color downloads start
    c.colors.downloads.start.fg = palette['orange']

    # Background color downloads start
    c.colors.downloads.start.bg = palette['background']

    # Foreground color downloads end
    ...
    c.colors.tabs.selected.even.bg = palette['comment']
    ...
    c.colors.tabs.selected.odd.bg = palette['comment']
